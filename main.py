...
Built using ADK for agents and Gemini for LLM capabilities. Challenges included async handling and API limits—resolved with retries and logging. Tested on sample repos, achieving high accuracy.
